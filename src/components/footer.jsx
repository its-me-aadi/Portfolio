    ...
    return (
        <footer>
            <div className='footer'>
                <div>
                <a href="mailto:itsadityasharma7124@gmail.com" title="Email me" rel="me" target="_blank">itsadityasharma7124@gmail.com</a>
                </div>
                <div>
                    <div className='footer-svg'>
                        <a href="https://github.com/its-me-aadi" target='blank' className='a-svgs'>
                    ...
                    <div className='footer-svg'>
                        <a href="https://www.linkedin.com/in/aditya-sharma-825016228/" target='blank' className='a-svgs'>
